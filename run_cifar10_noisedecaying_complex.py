...
def run_exp(args):
    cmd = "CUDA_VISIBLE_DEVICES={0} python3 train_lenet5_complex.py --epochs 500 --dataset cifar10 \
...
lambda_list =  [0.1, 0.2]#, 0.4, 0.6, 0.8] #list(np.arange(0.1, 0.15, 0.01)) + list(np.arange(0.15, 0.2, 0.01))+ list(np.arange(0.3, 0.4, 0.02))
