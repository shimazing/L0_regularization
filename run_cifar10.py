...
def run_exp(args):
    cmd = "CUDA_VISIBLE_DEVICES={0} python3 train_lenet5.py --dataset cifar10 --verbose --no-tensorboard --lambas {1} {1} {1} {1} {1} --sparsity {2} --rand_seed {3} --name {4}".format(
...
models = ["L0LeNet5-6-16-120-84", "L0LeNet5-12-32-200-100", "L0LeNet-24-64-400-200"]
